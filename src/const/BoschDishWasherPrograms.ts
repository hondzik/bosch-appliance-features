...
const boschDishwasherAllProgramsMap: Map<EBoschDishwasherProgram, BoschDishwasherProgram> = new Map([
...
const boschDishwasherModelProgramsMap: Map<EBoschModels, EBoschDishwasherProgram[]> = new Map([
