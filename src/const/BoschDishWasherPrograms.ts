 ...
 * added to src/assets/icons/dishwasher/programs/: AutoHalfLoad, ExpressSparkle65, GlassCare,
 * LearningDishwasher, Intensiv45, IntensivPower, MagicDaily, MaximumCleaning, MixedLoad, Normal45,
 * Normal65, PreRinse, Quick65, QuickD, SteamFresh, Super60.
 */
export const boschDishwasherAllProgramsMap: Map<string, BoschCatalogItem> = withIconPrefix<BoschCatalogItem>(
  'dishwasher/programs',
  new Map([
