...
export const boschDishwasherAllProgramsMap: Map<EBoschDishwasherProgram, BoschDishwasherProgram> =
  new Map([
    [
      EBoschDishwasherProgram.auto_1,
      { name: 'Auto 43-45°C', icon: 'auto', program: 'Dishcare.Dishwasher.Program.Auto1' },
    ],
    [
      EBoschDishwasherProgram.auto_2,
      { name: 'Auto 45-65°C', icon: 'auto', program: 'Dishcare.Dishwasher.Program.Auto2' },
    ],
    [
      EBoschDishwasherProgram.auto_3,
      { name: 'Auto 65-75°C', icon: 'auto', program: 'Dishcare.Dishwasher.Program.Auto3' },
    ],
    [
    ...
    [
      EBoschDishwasherProgram.glass_care,
      { name: 'Glass Care', icon: 'glass_care', program: 'Dishcare.Dishwasher.Program.GlassCare' },
    ], // TODO: icon
    [
    ...
    [
      EBoschDishwasherProgram.mixed_load,
      { name: 'Mixed Load', icon: 'mixed_load', program: 'Dishcare.Dishwasher.Program.MixedLoad' },
    ], // TODO: icon
    [
    ...
    [
      EBoschDishwasherProgram.normal_45,
      { name: 'Normal 45°C', icon: 'normal_45', program: 'Dishcare.Dishwasher.Program.Normal45' },
    ], // TODO: icon
    [
      EBoschDishwasherProgram.normal_65,
      { name: 'Normal 65°C', icon: 'normal_65', program: 'Dishcare.Dishwasher.Program.Normal65' },
    ], // TODO: icon
    [
      EBoschDishwasherProgram.pre_rinse,
      { name: 'Pre-rinse', icon: 'pre_rinse', program: 'Dishcare.Dishwasher.Program.PreRinse' },
    ], // TODO: icon
    [
    ...
    [
      EBoschDishwasherProgram.quick_65,
      { name: 'Quick 65°C', icon: 'express_65', program: 'Dishcare.Dishwasher.Program.Quick65' },
    ], // TODO: icon
    [
    ...
    [
      EBoschDishwasherProgram.super_60,
      { name: 'Super 60°C', icon: 'super_60', program: 'Dishcare.Dishwasher.Program.Super60' },
    ], // TODO: icon
  ]);

export const boschDishwasherModelProgramsMap: Map<EBoschModelGroup, EBoschDishwasherProgram[]> =
  new Map([
    [
