import { EBoschModelGroup, EBoschModel } from "./BoschModels";
...
export const boschDishwasherAllProgramsMap: Map<EBoschDishwasherProgram, BoschDishwasherProgram> = new Map([
    ...
    [EBoschDishwasherProgram.auto_half_load, { name: "Auto Half Load", icon: "auto_half_load", program: "Dishcare.Dishwasher.Program.AutoHalfLoad" }], // TODO: icon
    ...
    [EBoschDishwasherProgram.express_sparkle_65, { name: "Express Sparkle 65°C", icon: "express_sparkle_65", program: "Dishcare.Dishwasher.Program.ExpressSparkle65" }], // TODO: icon
    ...
    [EBoschDishwasherProgram.intelligent, { name: "Intelligent", icon: "intelligent", program: "Dishcare.Dishwasher.Program.LearningDishwasher" }], // TODO: icon
    [EBoschDishwasherProgram.intensive_45, { name: "Intensive 45°C", icon: "intensive_45", program: "Dishcare.Dishwasher.Program.Intensiv45" }], // TODO: icon
    ...
    [EBoschDishwasherProgram.intensive_power, { name: "Intensive Power", icon: "intensive_power", program: "Dishcare.Dishwasher.Program.IntensivPower" }], // TODO: icon
    [EBoschDishwasherProgram.magic_daily, { name: "Magic Daily", icon: "magic_daily", program: "Dishcare.Dishwasher.Program.MagicDaily" }], // TODO: icon
    [EBoschDishwasherProgram.machinecare, { name: "Machine Care", icon: "machinecare", program: "Dishcare.Dishwasher.Program.MachineCare" }],
    [EBoschDishwasherProgram.maximum_cleaning, { name: "Maximum Cleaning", icon: "maximum_cleaning", program: "Dishcare.Dishwasher.Program.MaximumCleaning" }], // TODO: icon
    ...
    [EBoschDishwasherProgram.quick_n_dry, { name: "Quick Wash & Dry", icon: "quick_n_dry", program: "Dishcare.Dishwasher.Program.QuickD" }], // TODO: icon
    [EBoschDishwasherProgram.steam_fresh, { name: "Steam Fresh", icon: "steam_fresh", program: "Dishcare.Dishwasher.Program.SteamFresh" }], // TODO: icon
